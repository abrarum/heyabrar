...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    abrarQuote:
      "Amazing experience working with Abrar. From the very beginning, he demonstrated a high level of professionalism, attention to detail, and exceptional commitment to the project. I asked him to build an AI chatbot integrated with Airtable for Airbnb guest assistance, and he not only met expectations but exceeded them in every way. Abrar not only completed all the required tasks with precision but also went above and beyond, adding improvements and additional features that truly made a difference in the final product. His communication was clear and consistent, always willing to listen and adjust to my needs. I highly recommend working with Abrar, and I will definitely reach out to him for future projects. Thank you, Abrar, for your incredible dedication and excellent work!",
    companyQuote:
