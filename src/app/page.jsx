...
export const metadata = {
  title: "HeyAbrar | AI and Full-stack Engineer",
  description:
    "Portfolio of Abrar, an AI and full-stack engineer building production systems across commerce, fintech, and regulated platforms.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
